    ...
    <>
      ...
      <div className="text-customBrown pb-4 md:pb-24 ">
        <div className="flex flex-col md:flex-row justify-center pt-8 md:pt-12 items-center">
          <div className="md:w-1/2 p-4 md:p-2 space-y-2 p-4 md:p-8">
            ...
            <p className="w-full text-lg md:text-xl md:w-full ">
          ...
          <div className="p-4 h-1/2 sm:px-12 md:p-0  w-full md:w-96"><img src={img1} className=" shadow-lg shadow-gray-500" alt="Gharat" /></div>
        </div>
      ...
      <div className="flex flex-col md:flex-row md:space-y-0 md:space-x-16 justify-center p-4 md:p-8 items-center bg-customYellow">
            <div className="space-y-4 ">
                <img src={img3} className="h-48 md:h-64 w-full md:w-96" alt="Farmer Training" />
                <img src={img1} className="h-48 md:h-64 w-full md:w-96" alt="Farmer Training" />
                <img src={img2} className="h-48 md:h-64 w-full md:w-96" alt="Farmer Training" />
            </div>
