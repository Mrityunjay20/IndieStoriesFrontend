...
export default function Sidebar({ onSelectSection }) {
    ...
    return (
        <div>
            ...
            {/* Sidebar */}
            <aside className={`fixed top-32 sm:top-0 left-0 h-screen bg-gray-200 transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-200 ease-in-out sm:relative sm:translate-x-0 sm:w-40 sm:block w-3/4 z-40`}>
